          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                return notificationsData.isNotEmpty ? ListView.builder(
                  shrinkWrap: true,
    ...
    return Padding(
      ...
      child: AlertDialog(
        ...
        actions: <Widget>[
          ...
          TextButton(
              child: const Text('Confirm', style: TextStyle(color: deleteColor)),
              onPressed: () {
                firebaseService.deleteAllCollection('userNotification','following',currentUserId);
